...
from numpy import empty, array, sum as np_sum, float32, timedelta64
...
class EnergyMonitor():
    ...
    def __del__(self):
        ...
        print("Stop monitoring GPUs energy consumption.")
    ...
    def energy(self):
        if self._process is None:
            print("Starting GPUs energy monitoring in background...",end = ' ')
